...
export async function activate(context: vscode.ExtensionContext) {
	...
	switch (runMode) {
		...
		case 'inline':
			...
			let extPy = vscode.extensions.getExtension("ms-python.python");
			let extCpp = vscode.extensions.getExtension("ms-vscode.cpptools");
			if(!extPy){
			...
			console.log(extPy.exports);
			console.log(extCpp.exports);
			...
			console.log(folders);
			vscode.debug.startDebugging(folders[0], "Python: Current File", undefined);
			*/
